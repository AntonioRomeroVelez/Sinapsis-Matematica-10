...
(function () {
    ...
    var GGBApplet = function () {
        ...
        applet.inject = function () {
            ...
            function continueInject() {
                ...
                if (parameters.width === undefined && appletElem.clientWidth) { parameters.width = appletElem.clientWidth }
                if (parameters.height === undefined && appletElem.clientHeight) { parameters.height = appletElem.clientHeight }
        ...
        var injectHTML5Applet = function (appletElem, parameters, noPreview) {
            ...
            applet.resize = function () { GGBAppletUtils.responsiveResize(appletElem, parameters) };
            ...
            function renderGGBElementWithParams(article, parameters) {
                if (parameters && typeof parameters.appletOnLoad === "function" && typeof renderGGBElement === "function") { renderGGBElement(article, parameters.appletOnLoad) } else { renderGGBElement(article) }
                ...
                if (typeof renderGGBElement === "undefined") {
                    ...
                    window.renderGGBElementReady = function () {
                        ...
                        if (html5AppletsToProcess !== null && html5AppletsToProcess.length) {
                            html5AppletsToProcess.forEach((function (obj) { renderGGBElementWithParams(obj.article, obj.params) }));
            ...
            if (loadScript) {
                ...
                if (!html5OverwrittenCodebase && (!html5OverwrittenCodebaseVersion || html5OverwrittenCodebaseVersion == "5.0")) {
                    if (html5CodebaseIsWebSimple) { webSimple.succeeded = webSimple.succeeded || webSimple() } else { web3d.succeeded = web3d.succeeded || web3d() }
                    scriptLoaded()
                } else if (html5Codebase.requirejs) { require(["geogebra/runtime/js/web3d/web3d.nocache"], scriptLoaded) } else {
                    script.onload = scriptLoaded;
                    appletElem.appendChild(script)
                }
            } else { renderGGBElementOnTube(article, parameters) }
        ...
        var setDefaultHTML5CodebaseForVersion = function (version, offline) {
            ...
            if (index > 0) { codebase = html5CodebaseVersion } else if (index === 0) { codebase = protocol + html5CodebaseVersion } else { codebase = "https://www.geogebra.org/apps/5.0.709.0/" }
        ...
        if (parameters.material_id !== undefined) { fetchParametersFromApi(continueInit) } else { continueInit() }
    ...
    var GGBAppletUtils = function () {
        ...
        function getWidthHeight(appletElem, appletWidth, allowUpscale, autoHeight, noBorder, scaleContainerClass) {
            ...
            if (appletElem) { if ((allowUpscale === undefined || !allowUpscale) && appletWidth > 0 && appletWidth + border < myWidth) { myWidth = appletWidth } else { myWidth -= border } if (typeof window.GGBT_wsf_view === "object" && window.GGBT_wsf_view.isFullscreen() && (allowUpscale === undefined || !allowUpscale)) { myHeight -= borderTop } }
    ...
    if (typeof define === "function" && define.amd) { define([], (function () { return GGBApplet })) }
    GGBAppletUtils.makeModule = function (name, permutation) {
        function webModule() {
            ...
            B();
            webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.709.0/" + name + "/";
    ...
    if (typeof window.web3d !== "function") { window.web3d = GGBAppletUtils.makeModule("web3d", "4FF70354EAF28D8D959CEAE516F4AB32") }
    if (typeof window.webSimple !== "function") { window.webSimple = GGBAppletUtils.makeModule("webSimple", "7CFBFAC58C13DAF503F8406EF5B88172") }
