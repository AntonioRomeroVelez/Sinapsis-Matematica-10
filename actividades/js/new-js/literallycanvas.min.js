! function (t) {
    ...
    return function t(e, n, i) {
        ...
        34: [function (t, e, n) {
            var i, r, o, s, a, h, l, c;
            a = t("./React-shim"), i = a.createFactory(t("./ClearButton")), h = a.createFactory(t("./UndoRedoButtons")), l = a.createFactory(t("./ZoomButtons")), c = t("../core/localization")._, o = a.createFactory(t("./ColorWell")), r = a.createFactory(a.createClass({ displayName: "ColorPickers", render: function () { var t, e; return e = this.props.lc, (t = a.DOM.div)({ className: "lc-color-pickers" }, o({ lc: e, colorName: "primary", label: c("linea") }), o({ lc: e, colorName: "secondary", label: c("relleno") }), o({ lc: e, colorName: "background", label: c("bgd") })) } })), s = a.createClass({ displayName: "Picker", getInitialState: function () { return { selectedToolIndex: 0 } }, renderBody: function () { var t, e, n, o, s; return t = a.DOM.div, o = this.props, s = o.toolButtonComponents, n = o.lc, e = o.imageURLPrefix, t({ className: "lc-picker-contents" }, s.map(function (t) { return function (i, r) { return i({ lc: n, imageURLPrefix: e, key: r, isSelected: r === t.state.selectedToolIndex, onSelect: function (e) { return n.setTool(e), t.setState({ selectedToolIndex: r }) } }) } }(this)), s.length % 2 !== 0 ? t({ className: "toolbar-button thin-button disabled" }) : void 0, t({ style: { position: "absolute", bottom: 0, left: 0, right: 0 } }, r({ lc: this.props.lc }), h({ lc: n, imageURLPrefix: e }), l({ lc: n, imageURLPrefix: e }), i({ lc: n }))) }, render: function () { var t; return (t = a.DOM.div)({ className: "lc-picker" }, this.renderBody()) } }), e.exports = s
