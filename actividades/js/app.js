...
document.querySelectorAll("[data-color]").forEach(
    (el) => {
        el.addEventListener("click", (e) =>{
            ...
            var colorTexto = el.getAttribute("data-color");
            document.getElementById("colorTexto").innerHTML = colorTexto;
        });
    }
);
...
$('.1').click(function() {
    switch ($(this).attr('class')) {
        case '1 enc1a1':
            ...
            $('.enc1a2').removeClass('canvasseleccion');

            break;
        case '1 enc1a2':
            $('.enc1a2').addClass('canvasseleccion');
            $('.enc1a1').removeClass('canvasseleccion');
