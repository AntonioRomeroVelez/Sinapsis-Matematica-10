...
function f_titulos() {
    ...
    switch (titulos) {
        ...
        case "preparo":
            ...
            break;
        case "evaluacion":
            $(".titulo").html("").append("<img src='img/ico_Sumativa.png' alt=''> Evaluación sumativa");
            break;
        case "prueba":
        ...
        case "problemas":
            ...
            break;
        case "somos2":
            $(".titulo").html("").append("<img src='img/somos2.png' alt='Somos nnovadores'> Somos innovadores");
            break;
    }
};
