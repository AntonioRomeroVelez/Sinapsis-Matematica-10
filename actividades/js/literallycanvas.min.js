! function (t) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
        ...
        var e;
        e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.LC = t()
    }
}(function () {
    return function t(e, n, i) {
        function r(s, a) {
            if (!n[s]) {
                if (!e[s]) { var h = "function" == typeof require && require; if (!a && h) return h(s, !0); if (o) return o(s, !0); var l = new Error("Cannot find module '" + s + "'"); throw l.code = "MODULE_NOT_FOUND", l } var c = n[s] = { exports: {} };
                e[s][0].call(c.exports, function (t) { var n = e[s][1][t]; return r(n ? n : t) }, c, c.exports, t, e, n, i)
            } return n[s].exports
        ...
        1: [function (t, e, n) {
            ...
            function i(t, e) {
                if (t === e) return !0; if ("object" != typeof t || null === t || "object" != typeof e || null === e) return !1; var n = Object.keys(t),
                    i = Object.keys(e); if (n.length !== i.length) return !1; for (var o = r.bind(e), s = 0; s < n.length; s++)
                    if (!o(n[s]) || t[n[s]] !== e[n[s]]) return !1; return !0
        ...
        3: [function (t, e, n) {
            "use strict"; var i = t("./shallowCompare"),
        ...
        5: [function (t, e, n) {
            var i, r, o, s, a, h, l, c, u, p, d, f, g, m, y, S = function (t, e) { return function () { return t.apply(e, arguments) } },
                v = [].slice,
            ...
            a = t("./actions"), h = t("./bindEvents"), c = t("./math"), u = t("./shapes"), l = u.createShape, m = u.shapeToJSON, r = u.JSONToShape, p = t("./canvasRenderer").renderShapeToContext, d = t("./svgRenderer").renderShapeToSVG, f = t("./renderSnapshotToImage"), g = t("./renderSnapshotToSVG"), s = t("../tools/Pencil"), y = t("./util"), i = "infinite", e.exports = o = function () {
                ...
                }, t.prototype.loadSnapshotJSON = function (t) { return console.warn("lc.loadSnapshotJSON() is deprecated. use lc.loadSnapshot(JSON.parse(snapshot)) instead."), this.loadSnapshot(JSON.parse(t)) }, t
            }()
        }, { "../tools/Pencil": 48, "./actions": 7, "./bindEvents": 8, "./canvasRenderer": 9, "./math": 14, "./renderSnapshotToImage": 15, "./renderSnapshotToSVG": 16, "./shapes": 17, "./svgRenderer": 18, "./util": 19 }],
        6: [function (t, e, n) {
            var i, r, o, s;
            t("./fontmetrics.js"), s = function (t) { var e, n, i, r, o, s, a, h; for (n = t.split(" "), i = 0, o = 0, s = n.length; s > o; o++) r = n[o], a = parseInt(r.replace("px", ""), 10), isNaN(a) || (i = a); if (!i) throw "Font size not found"; return h = t.substring(n[0].length + 1).replace("bold ", "").replace("italic ", "").replace("underline ", ""), e = h, { fontSize: i, fontFamily: e } }, o = function (t, e, n) {
                var i, r, o, s, a, h, l, c, u, p; if (!e.length) return ["", ""]; for (r = 0, h = 0, l = 0, p = !1; ;)
                    if (r += 1, o = r >= e.length, a = !o && e[r].match(/\s/), s = a || o, u = e.substring(0, r), i = n ? t.measureTextWidth(u).width <= n : !0, i && (l = r), s && p && (p = !1, i && (h = r)), p = !a, o || !i) { if (i) return [e, ""]; if (h > 0) { for (c = h + 1; c < e.length && e[c].match("/s/");) c += 1; return [e.substring(0, h), e.substring(c)] } return [e.substring(0, l), e.substring(l)] }
            }, r = function (t, e, n) {
                var i, r, s, a, h, l, c, u, p; for (p = e.split(/\r\n|\r|\n/g), s = [], i = 0, r = p.length; r > i; i++)
                    if (u = p[i], h = o(t, u, n), a = h[0], c = h[1], a)
                        for (; a;) s.push(a), l = o(t, c, n), a = l[0], c = l[1];
                    else s.push(u); return s
            }, i = function () {
                ...
                } return t.prototype.draw = function (t, e, n) { var i, r, o, s, a, h; for (t.textBaseline = "top", t.font = this.font, i = 0, a = this.lines, h = [], r = 0, o = a.length; o > r; r++) s = a[r], t.fillText(s, e, n + i * this.metrics.leading), h.push(i += 1); return h }, t.prototype.getWidth = function (t) { return null == t && (t = !1), this.forcedWidth ? this.forcedWidth : t ? this.metrics.bounds.maxx + this.caratWidth : this.metrics.bounds.maxx }, t.prototype.getHeight = function () { return this.forcedHeight || this.metrics.leading * this.lines.length }, t
            }(), e.exports = i
        }, { "./fontmetrics.js": 11 }],
        7: [function (t, e, n) {
            var i, r;
            r = function () {
                function t(t, e, n) { this.lc = t, this.oldShapes = e, this.newShapes = n } return t.prototype["do"] = function () { return this.lc.shapes = this.newShapes, this.lc.repaintLayer("main") }, t.prototype.undo = function () { return this.lc.shapes = this.oldShapes, this.lc.repaintLayer("main") }, t
            }(), i = function () {
                function t(t, e, n) { this.lc = t, this.shape = e, this.previousShapeId = null != n ? n : null } return t.prototype["do"] = function () {
                    var t, e, n, i, r, o; if (this.lc.shapes.length && this.lc.shapes[this.lc.shapes.length - 1].id !== this.previousShapeId && null !== this.previousShapeId) {
                        for (i = [], t = !1, r = this.lc.shapes, e = 0, n = r.length; n > e; e++) o = r[e], i.push(o), o.id === this.previousShapeId && (i.push(this.shape), t = !0);
                        t || i.push(this.shape), this.lc.shapes = i
                    } else this.lc.shapes.push(this.shape); return this.lc.repaintLayer("main")
                }, t.prototype.undo = function () {
                    var t, e, n, i, r; if (this.lc.shapes[this.lc.shapes.length - 1].id === this.shape.id) this.lc.shapes.pop();
                    else {
                        for (n = [], i = this.lc.shapes, t = 0, e = i.length; e > t; t++) r = i[t], r.id !== this.shape.id && n.push(r);
                        lc.shapes = n
                    } return this.lc.repaintLayer("main")
                }, t
            }(), e.exports = { ClearAction: r, AddShapeAction: i }
        }, {}],
        8: [function (t, e, n) {
            var i, r, o, s;
            o = function (t, e) { var n, i, r; return i = e.changedTouches[0].clientX, r = e.changedTouches[0].clientY, n = t.getBoundingClientRect(), [i - n.left, r - n.top] }, s = function (t, e) { var n; return n = t.getBoundingClientRect(), { left: e.clientX - n.left, top: e.clientY - n.top } }, r = function (t) { return null != t.buttons ? 1 === t.buttons : t.which > 0 }, e.exports = i = function (t, e, n) {
                var i, r, a, h, l, c; return null == n && (n = !1), c = [], r = function (n) { return function (n) { var i; return n.preventDefault(), i = s(e, n), t.pointerMove(i.left, i.top) } }(this), a = function (n) { return function (n) { var i; return n.preventDefault(), e.onselectstart = function () { return !0 }, i = s(e, n), t.pointerUp(i.left, i.top), document.removeEventListener("mousemove", r), document.removeEventListener("mouseup", a), e.addEventListener("mousemove", r) } }(this), e.addEventListener("mousedown", function (n) { return function (n) { var i, o; if ("canvas" === n.target.tagName.toLowerCase()) return i = !0, n.preventDefault(), e.onselectstart = function () { return !1 }, o = s(e, n), t.pointerDown(o.left, o.top), e.removeEventListener("mousemove", r), document.addEventListener("mousemove", r), document.addEventListener("mouseup", a) } }(this)), l = function (n) { return n.preventDefault(), t.pointerMove.apply(t, o(e, n)) }, h = function (n) { return n.preventDefault(), t.pointerUp.apply(t, o(e, n)), document.removeEventListener("touchmove", l), document.removeEventListener("touchend", h), document.removeEventListener("touchcancel", h) }, e.addEventListener("touchstart", function (n) { return "canvas" === n.target.tagName.toLowerCase() ? (n.preventDefault(), 1 === n.touches.length ? (t.pointerDown.apply(t, o(e, n)), document.addEventListener("touchmove", l), document.addEventListener("touchend", h), document.addEventListener("touchcancel", h)) : t.pointerMove.apply(t, o(e, n))) : void 0 }), n && (console.warn("Keyboard panning is deprecated."), i = function (e) {
                    switch (e.keyCode) {
                        case 37:
                            t.pan(-10, 0); break;
                        case 38:
        ...
        11: [function (t, e, n) {
            "use strict"; ! function () {
                ...
                CanvasRenderingContext2D.prototype.measureText2 = function (e, n, i) {
                    var r = this.measureTextWidth(e),
                        o = !/\S/.test(e);
                    ...
                    s.style.position = "absolute", s.style.opacity = 0, s.style.font = i, s.innerHTML = e + "<br/>" + e, document.body.appendChild(s), r.leading = 1.2 * n; var a = t(s, "height"); if (a = a.replace("px", ""), a >= 2 * n && (r.leading = a / 2 | 0), document.body.removeChild(s), o) r.ascent = 0, r.descent = 0, r.bounds = { minx: 0, maxx: r.width, miny: 0, maxy: 0 }, r.height = 0;
                        ...
                        r.ascent = d - S, r.descent = v - d, r.bounds = { minx: x - l / 2, maxx: k - l / 2, miny: 0, maxy: v - S }, r.height = 1 + (v - S)
                    } return r
                }
            }()
        }, {}],
        ...
        14: [function (t, e, n) {
            var i, r, o, s, a, h;
            i = t("./shapes").Point, h = t("./util"), o = {}, o.toPoly = function (t) { var e, n, i, o, a, h, l; for (h = [], l = [], n = 0, e = 0, i = t.length; i > e; e++) a = t[e], o = s(a, r(t, n)), h = h.concat([o[0]]), l = [o[1]].concat(l), n += 1; return h.concat(l) }, r = function (t, e) { var n; return t.length < 3 && (n = { x: 0, y: 0 }), n = 0 === e ? r(t, e + 1) : e === t.length - 1 ? r(t, e - 1) : o.diff(t[e - 1], t[e + 1]) }, o.diff = function (t, e) { return { x: e.x - t.x, y: e.y - t.y } }, a = function (t) { var e; return e = o.len(t), { x: t.x / e, y: t.y / e } }, s = function (t, e) { return e = a(e), e.x = e.x * t.size / 2, e.y = e.y * t.size / 2, [{ x: t.x - e.y, y: t.y + e.x, color: t.color }, { x: t.x + e.y, y: t.y - e.x, color: t.color }] }, o.len = function (t) { return Math.sqrt(Math.pow(t.x, 2) + Math.pow(t.y, 2)) }, o.scalePositionScalar = function (t, e, n, i) { var r, o; return o = e * n, r = e * i, t + (o - r) / 2 }, e.exports = o
        }, { "./shapes": 17, "./util": 19 }],
        15: [function (t, e, n) {
            var i, r, o, s;
        ...
        23: [function (t, e, n) {
            var i, r, o, s, a, h, l, c, u, p, d, f, g, m, y, S, v, x, w, k, b, C, P; for (a = t("../reactGUI/React-shim"), u = t("./optionsStyles").defineOptionsStyle, c = t("../core/localization")._, h = [
        ...
        32: [function (t, e, n) {
            ...
            t("../optionsStyles/font"), t("../optionsStyles/stroke-width"), t("../optionsStyles/line-options-and-stroke-width"), t("../optionsStyles/polygon-and-stroke-width"), t("../optionsStyles/null"); var d = i.createClass({ displayName: "CanvasContainer", shouldComponentUpdate: function () { return !1 }, render: function () { return i.createElement("div", { key: "literallycanvas", className: "lc-drawing with-gui" }) } }),
                f = i.createClass({
                    displayName: "LiterallyCanvas", getDefaultProps: function () { return p }, bindToModel: function () {
                        var t = o(this.canvas);
                        this.props;
                        this.lc.bindToElement(t), "function" == typeof this.lc.opts.onInit && this.lc.opts.onInit(this.lc)
                    }, componentWillMount: function () {
                        var t = this;
                        this.lc || (this.props.lc ? this.lc = this.props.lc : this.lc = new u(this.props), this.toolButtonComponents = this.lc.opts.tools.map(function (e) { return c(new e(t.lc)) }))
                    }, componentDidMount: function () { this.lc.isBound || this.bindToModel() }, componentWillUnmount: function () { this.lc && this.lc._teardown() }, render: function () {
                        var t = this,
                            e = this.lc,
        ...
        33: [function (t, e, n) {
            var i, r, o, s;
            r = t("./React-shim"), o = t("./createSetStateOnEventMixin"), s = t("../optionsStyles/optionsStyles").optionsStyles, i = r.createClass({ displayName: "Options", getState: function () { var t; return { style: null != (t = this.props.lc.tool) ? t.optionsStyle : void 0, tool: this.props.lc.tool } }, getInitialState: function () { return this.getState() }, mixins: [o("toolChange")], renderBody: function () { var t; return t = "" + this.state.style, s[t] && s[t]({ lc: this.props.lc, tool: this.state.tool, imageURLPrefix: this.props.imageURLPrefix }) }, render: function () { var t; return (t = r.DOM.div)({ className: "lc-options horz-toolbar" }, this.renderBody()) } }), e.exports = i
        }, { "../optionsStyles/optionsStyles": 26, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        34: [function (t, e, n) {
            var i, r, o, s, a, h, l, c;
            a = t("./React-shim"), i = a.createFactory(t("./ClearButton")), h = a.createFactory(t("./UndoRedoButtons")), l = a.createFactory(t("./ZoomButtons")), c = t("../core/localization")._, o = a.createFactory(t("./ColorWell")), r = a.createFactory(a.createClass({ displayName: "ColorPickers", render: function () { var t, e; return e = this.props.lc, (t = a.DOM.div)({ className: "lc-color-pickers" }, o({ lc: e, colorName: "primary", label: c("color linea") }), o({ lc: e, colorName: "secondary", label: c("color relleno") }), o({ lc: e, colorName: "background", label: c("bgd") })) } })), s = a.createClass({ displayName: "Picker", getInitialState: function () { return { selectedToolIndex: 0 } }, renderBody: function () { var t, e, n, o, s; return t = a.DOM.div, o = this.props, s = o.toolButtonComponents, n = o.lc, e = o.imageURLPrefix, t({ className: "lc-picker-contents" }, s.map(function (t) { return function (i, r) { return i({ lc: n, imageURLPrefix: e, key: r, isSelected: r === t.state.selectedToolIndex, onSelect: function (e) { return n.setTool(e), t.setState({ selectedToolIndex: r }) } }) } }(this)), s.length % 2 !== 0 ? t({ className: "toolbar-button thin-button disabled" }) : void 0, t({ style: { position: "absolute", bottom: 0, left: 0, right: 0 } }, r({ lc: this.props.lc }), h({ lc: n, imageURLPrefix: e }), l({ lc: n, imageURLPrefix: e }), i({ lc: n }))) }, render: function () { var t; return (t = a.DOM.div)({ className: "lc-picker" }, this.renderBody()) } }), e.exports = s
        }, { "../core/localization": 13, "./ClearButton": 30, "./ColorWell": 31, "./React-shim": 35, "./UndoRedoButtons": 38, "./ZoomButtons": 39 }],
        35: [function (t, e, n) {
            var i; try { i = t("react") } catch (r) { i = window.React } if (null == i) throw "Can't find React";
            e.exports = i
        }, { react: "react" }],
        36: [function (t, e, n) {
            var i; try { i = t("react-dom") } catch (r) { i = window.ReactDOM } if (null == i) try { i = t("react") } catch (o) { i = window.React }
            if (null == i) throw "Can't find ReactDOM";
            e.exports = i
        }, { react: "react", "react-dom": "react-dom" }],
        37: [function (t, e, n) {
            var i, r, o;
            i = t("./React-shim"), o = t("../reactGUI/createSetStateOnEventMixin"), r = t("../core/util").classSet, e.exports = i.createClass({ displayName: "StrokeWidthPicker", getState: function (t) { return null == t && (t = this.props.tool), { strokeWidth: t.strokeWidth } }, getInitialState: function () { return this.getState() }, mixins: [o("toolDidUpdateOptions")], componentWillReceiveProps: function (t) { return this.setState(this.getState(t.tool)) }, render: function () { var t, e, n, o, s, a, h; return o = i.DOM, h = o.ul, n = o.li, a = o.svg, t = o.circle, e = o.div, s = this.props.lc.opts.strokeWidths, e({}, s.map(function (n) { return function (i, o) { var s, h; return s = r({ "square-toolbar-button": !0, selected: i === n.state.strokeWidth }), h = 28, e({ key: i }, e({ className: s, onClick: function () { return n.props.lc.trigger("setStrokeWidth", i) } }, a({ width: h - 2, height: h - 2, viewPort: "0 0 " + i + " " + i, version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, t({ cx: Math.ceil(h / 2 - 1), cy: Math.ceil(h / 2 - 1), r: i / 2 })))) } }(this))) } })
        }, { "../core/util": 19, "../reactGUI/createSetStateOnEventMixin": 40, "./React-shim": 35 }],
        38: [function (t, e, n) {
            var i, r, o, s, a, h, l;
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function (t) {
                return i.createClass({
                    displayName: "undo" === t ? "UndoButton" : "RedoButton", getState: function () {
                        return {
                            isEnabled: function () {
                                switch (!1) {
                                    case "undo" !== t:
                    ...
                    }, getInitialState: function () { return this.getState() }, mixins: [h("drawingChange")], render: function () {
                        var e, n, r, o, s, h, l, c, u, p, d; return l = i.DOM, n = l.div, o = l.img, c = this.props, s = c.lc, r = c.imageURLPrefix, d = "undo" === t ? "Undo" : "Redo", e = "lc-" + t + " " + a({ "toolbar-button": !0, "thin-button": !0, disabled: !this.state.isEnabled }), h = function () {
                            switch (!1) {
                                ...
                                case "redo" !== t:
                                    return function () { return s.redo() }
                            }
                        }.call(this), u = r + "/" + t + ".png", p = { backgroundImage: "url(" + u + ")" }, n({ className: e, onClick: h, title: d, style: p })
                    }
                })
            }, o = i.createFactory(l("undo")), r = i.createFactory(l("redo")), s = i.createClass({ displayName: "UndoRedoButtons", render: function () { var t; return (t = i.DOM.div)({ className: "lc-undo-redo" }, o(this.props), r(this.props)) } }), e.exports = s
        }, { "../core/util": 19, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        39: [function (t, e, n) {
            var i, r, o, s, a, h, l;
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function (t) {
                return i.createClass({
                    displayName: "in" === t ? "ZoomInButton" : "ZoomOutButton", getState: function () {
                        return {
                            isEnabled: function () {
                                switch (!1) {
                                    case "in" !== t:
                    ...
                    }, getInitialState: function () { return this.getState() }, mixins: [h("zoom")], render: function () {
                        var e, n, r, o, s, h, l, c, u, p, d; return l = i.DOM, n = l.div, o = l.img, c = this.props, s = c.lc, r = c.imageURLPrefix, d = "in" === t ? "Zoom in" : "Zoom out", e = "lc-zoom-" + t + " " + a({ "toolbar-button": !0, "thin-button": !0, disabled: !this.state.isEnabled }), h = function () {
                            switch (!1) {
                                case !!this.state.isEnabled:
                                    return function () { };
                                case "in" !== t:
                        ...
                        }.call(this), u = r + "/zoom-" + t + ".png", p = { backgroundImage: "url(" + u + ")" }, n({ className: e, onClick: h, title: d, style: p })
                    }
                })
            }, s = i.createFactory(l("out")), o = i.createFactory(l("in")), r = i.createClass({ displayName: "ZoomButtons", render: function () { var t; return (t = i.DOM.div)({ className: "lc-zoom" }, s(this.props), o(this.props)) } }), e.exports = r
        }, { "../core/util": 19, "./React-shim": 35, "./createSetStateOnEventMixin": 40 }],
        40: [function (t, e, n) {
            var i, r;
            i = t("./React-shim"), e.exports = r = function (t) { return { componentDidMount: function () { return this.unsubscribe = this.props.lc.on(t, function (t) { return function () { return t.setState(t.getState()) } }(this)) }, componentWillUnmount: function () { return this.unsubscribe() } } }
        }, { "./React-shim": 35 }],
        41: [function (t, e, n) {
            var i, r, o, s;
            i = t("./React-shim"), o = t("../core/util").classSet, r = t("../core/localization")._, s = function (t) { var e, n; return e = t.name, n = t.iconName, i.createFactory(i.createClass({ displayName: e, getDefaultProps: function () { return { isSelected: !1, lc: null } }, componentWillMount: function () { return this.props.isSelected ? this.props.lc.setTool(t) : void 0 }, render: function () { var s, a, h, l, c, u, p, d, f; return p = i.DOM, a = p.div, l = p.img, d = this.props, h = d.imageURLPrefix, c = d.isSelected, u = d.onSelect, s = o({ "lc-pick-tool": !0, "toolbar-button": !0, "thin-button": !0, selected: c }), f = h + "/" + n + ".png", a({ className: s, style: { backgroundImage: "url(" + f + ")" }, onClick: function () { return u(t) }, title: r(e) }) } })) }, e.exports = s
        ...
        42: [function (t, e, n) {
            ...
            function i(t, e) {
                var n = t.className,
                    i = new s(e); return o.render(r.createElement(a, { lc: i }), t), i.teardown = function () {
                        i._teardown(); for (var e = 0; e < t.children.length; e++) t.removeChild(t.children[e]);
                        t.className = n
                    }, i
            } var r = t("./React-shim"),
                o = t("./ReactDOM-shim"),
        ...
        44: [function (t, e, n) {
            ...
            r = t("./Pencil"), o = t("../core/shapes").createShape, e.exports = i = function (t) {
                function e() { return e.__super__.constructor.apply(this, arguments) } return s(e, t), e.prototype.name = "Borrador", e.prototype.iconName = "eraser", e.prototype.makePoint = function (t, e, n) { return o("Point", { x: t, y: e, size: this.strokeWidth, color: "#000" }) }, e.prototype.makeShape = function () { return o("ErasedLinePath") }, e
            }(r)
        ...
        46: [function (t, e, n) {
            var i, r, o, s = function (t, e) {
                ...
                a = {}.hasOwnProperty;
            r = t("./base").ToolWithStroke, o = t("../core/shapes").createShape, e.exports = i = function (t) {
                function e() { return e.__super__.constructor.apply(this, arguments) } return s(e, t), e.prototype.name = "Linea", e.prototype.iconName = "line", e.prototype.optionsStyle = "line-options-and-stroke-width", e.prototype.begin = function (t, e, n) {
                    return this.currentShape = o("Line", {
                        x1: t, y1: e, x2: t, y2: e, strokeWidth: this.strokeWidth, dash: function () {
                            switch (!1) {
                                case !this.isDashed:
                        ...
                        }.call(this), endCapShapes: this.hasEndArrow ? [null, "arrow"] : null, color: n.getColor("primary")
                    })
                }, e.prototype["continue"] = function (t, e, n) { return this.currentShape.x2 = t, this.currentShape.y2 = e, n.drawShapeInProgress(this.currentShape) }, e.prototype.end = function (t, e, n) { return n.saveShape(this.currentShape) }, e
            }(r)
        }, { "../core/shapes": 17, "./base": 53 }],
        47: [function (t, e, n) {
            var i, r, o, s = function (t, e) {
